...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "metadata.for_scriveners" });
  return { title: t("title"), description: t("description") };
}

const painPointIcons = [FileText, FileText, AlertTriangle, Users];
...
const serviceLinks = [
  { href: "/services#lto", labelKey: "service_link_lto" as const },
  { href: "/services#documents", labelKey: "service_link_documents" as const },
  { href: "/services#marriage", labelKey: "service_link_marriage" as const },
];

export default async function ForScrivenersPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations({ locale, namespace: "for_scriveners_page" });
        ...
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {([1, 2, 3] as const).map((n) => (
              <div
                key={n}
                className="flex items-start gap-3 rounded-lg border border-gray-100 bg-gray-50 p-5"
              >
        ...
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6">
              ...
              <Link
                href={`/${locale}/services#documents`}
